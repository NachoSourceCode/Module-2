...
namespace Average_Ten_Scores
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /* sets the variable 'sum' is equal to the sum of each of the variables. Then 'average' is set 
              equal to 'sum' / 10.*/
            int sum = num1 + num2 + num3 + num4 + num5 + num6 + num7 + num8 + num9 + num10;
            int average = sum / 10;

            /* This statement prints the interpolated string which means the value will replace the 'average'
